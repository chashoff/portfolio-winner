        ...
        return (
            <>
                ...
                <div className="column-grid">
                    <div />
                    <GridItem title="Blog" descriptio="Come check out all the problems I have faced while coding, and how I went about fixing them!" border="4px solid lightgreen" stateValue={this.state.blog} enter={this.enterZoneChange} leave={this.leaveZoneChange} />
